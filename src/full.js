...
const full = () => {
  const fullDeails = async () =>{
    ...
    const ui = await axios.post("http://localhost:9000/signUp/users",{"name":"mazi","email":"mazi@gmail.com", "password":"0534113092","links":[]})
    console.log(ui)
    ...
    const ui2 = await axios.post("http://localhost:9000/signUp/users",{"name":"shira","email":"shira@gmail.com" , "password":"12345678","links":[]})
    ...
    const user3 = await axios.post("http://localhost:9000/signUp/users",{"name":"shoshi","email":"shoshi@gmail.com" , "password":"5458565253","links":[]})
    ...
    await axios.post("http://localhost:9000/signUp/users",{"name":"michal","email":"michal@gmail.com" , "password":"18542145"})
    await axios.post("http://localhost:9000/signUp/users",{"name":"brachi","email":"brachi@gmail.com" , "password":"556332215"})
    await axios.post("http://localhost:9000/signUp/users",{"name":"avishag","email":"avishag@gmail.com" , "password":"shug412"})
    await axios.post("http://localhost:9000/signUp/users",{"name":"tamear","email":"tamear@gmail.com" , "password":"11110000"})
    await axios.post("http://localhost:9000/signUp/users",{"name":"ruti","email":"ruti@gmail.com" , "password":"r12121212"})
  }
    return (
        <div className="sign">
